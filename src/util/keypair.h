...
public:
        ...
        struct ServerEntry {
                std::string username;
                std::string server_name;  ///< v9.41: Human-readable server name (from favorites/announcement)
        ...
        /**
         * v9.41: Remember the last username used for a given server address,
         * including the human-readable server name.
         * @param server_address  The server address (host:port).
         * @param username        The username used.
         * @param server_name     The human-readable server name (e.g. from favorites).
         */
        void rememberServerUser(const std::string &server_address,
                const std::string &username,
