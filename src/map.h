...
struct MapEditEvent
{
        ...
        void setModifiedBlocks(const std::unordered_map<v3s16, MapBlock *>& blocks)
        {
                assert(modified_blocks.empty()); // only meant for initialization (once)
...
public:
        ...
        */
        std::unordered_set<v3s16> getCoveredBlocks() const;
        ...
        */
        void blitBackAll(std::unordered_map<v3s16, MapBlock*> * modified_blocks,
