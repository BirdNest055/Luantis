...
void Translations::clear()
{
        ...
        // for large translation maps instead of leaving capacity allocated.
        {
                std::unordered_map<std::wstring, std::wstring> empty;
                std::swap(m_translations, empty);
        }
        {
                std::unordered_map<std::wstring, std::pair<GettextPluralForm::Ptr, std::vector<std::wstring>>> empty;
                std::swap(m_plural_translations, empty);
        }
}
