...
{
        s16 level = baseTerrainLevelFromNoise(p) + MGV6_AVERAGE_MUD_AMOUNT;
        // Clamp to valid bounds: the ground level must be within
        // [-MAX_MAP_GENERATION_LIMIT, MAX_MAP_GENERATION_LIMIT]
        return rangelim(level, -MAX_MAP_GENERATION_LIMIT, MAX_MAP_GENERATION_LIMIT);
}
