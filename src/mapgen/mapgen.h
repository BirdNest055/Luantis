...
public:
        ...
        // The returned value must not be below -MAX_MAP_GENERATION_LIMIT.
        virtual int getSpawnLevelAtPoint(v2s16 p) {
                // Default: return 0 (suitable for flat/singlenode mapgens).
                // Subclasses that compute a spawn level must ensure the result
                // is not below -MAX_MAP_GENERATION_LIMIT.
                return 0;
        }
