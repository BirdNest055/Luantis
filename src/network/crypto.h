...
public:
        ...
        /// v9.15: Grace period fields REMOVED.
        /// The 0x80 encrypted flag byte is the SOLE determinant of whether
        /// a packet is encrypted. If a packet has the 0x80 flag, it's encrypted.
        /// If not, it's plaintext — regardless of whether encryption is active.
        /// This eliminates the need for grace periods, transition counters,
        /// and all the error spam they caused.
        ///
        /// Previous versions (v9.13/v9.14) used grace periods because they
        /// checked `encryption_active` before the 0x80 flag, causing plaintext
        /// packets to be treated as security violations during the transition.
        /// The correct approach is: check the 0x80 flag FIRST. If absent,
        /// always process as plaintext (no error, no grace period needed).
        ...
        /// v9.15: Grace period fields removed — the 0x80 flag alone
        /// determines if a packet is encrypted, so no transition tracking needed.
        void activate()
        {
