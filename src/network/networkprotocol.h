...
enum ToClientCommand : u16
{
        ...
        /*
                ...
                u8 security_flags (optional, since protocol extension)
                        bit 0: ENCRYPTED — transport encryption is active
                        bit 1: ENCRYPTION_SUPPORTED — encryption available but not yet active
        */
...
enum AccessDeniedCode : u8 {
        ...
        SERVER_ACCESSDENIED_RATE_LIMIT,
