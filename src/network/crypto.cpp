...
// FingerprintStore is now in its own translation unit
// (network/encryption/fingerprint_store.cpp) and is NOT conditionally
// compiled — it works with or without OpenSSL.
