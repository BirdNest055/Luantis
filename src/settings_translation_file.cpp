...
fake_function() {
        ...
        // v8: Security Info Tab — new section and settings
        gettext("Security Info");
        gettext("Security");
        gettext("Secure connection");
        gettext("Enable secure (encrypted) connection for game traffic.\nWhen enabled, the server advertises to clients that the connection is\nencrypted, and clients will not show the \"INSECURE CONNECTION\" warning overlay.\nCurrently this only sets a protocol flag; actual transport encryption\nwill be added in a future release.");
        gettext("Show security overlay");
        gettext("Show the security overlay warning when the connection is insecure.\nWhen enabled, a persistent \"INSECURE CONNECTION\" banner is displayed at the\ntop-right of the screen during multiplayer sessions on unencrypted connections.\nThis overlay is never shown in singleplayer mode.");
        gettext("Show connection info in debug");
        gettext("Whether to show the connection type indicator in the debug info area.\nWhen enabled, the connection security state (Secure/Insecure) is\nincluded in the F5 debug text. This is a building block for future\noverlay indicators (latency, packet loss, etc.).");
        gettext("Connection Security Details");
        gettext("Encryption & Authentication");
        gettext("Certificate & Trust");
        gettext("Security Properties");
        gettext("Session & Connection");
        gettext("Security Score:");
        gettext("Connection State:");
        gettext("Encryption:");
        gettext("Cipher Suite:");
        gettext("Key Exchange:");
        gettext("Authentication:");
        gettext("TLS Version:");
        gettext("Certificate:");
        gettext("Server Fingerprint:");
        gettext("Forward Secrecy:");
        gettext("Replay Protection:");
        gettext("Session ID:");
        ...
        gettext("WARNING: Your connection is not encrypted!");
        gettext("All game traffic is sent as plaintext and could be");
        gettext("intercepted by third parties on your network.");
        gettext("Enable 'Secure connection' in server settings to fix this.");
        gettext("Your connection is secured with encryption.");
        gettext("Game traffic is protected from eavesdropping.");
        gettext("Not currently connected to a server.");
        gettext("Security details will appear when you join a server.");
        gettext("Connect to a server to see security details.");
        gettext("Forward secrecy: Past sessions stay safe even if long-term keys are compromised.");
        gettext("No forward secrecy: Compromised keys could reveal past session data.");
        gettext("Replay protection: Duplicate packets are detected and rejected.");
