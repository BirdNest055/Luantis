...
{
        // Note: m_formspec may not reflect the actual top menu when
        // pause-menu submenus are open (they bypass m_formspec via g_menumgr).
        // Always query g_menumgr for the real top-level menu.
        GUIModalMenu *menu = g_menumgr.tryGetTopMenu();
        if (menu) {
