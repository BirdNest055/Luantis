...
private:
        ...
        // Batch 34: Atomic flag replacement — m_is_paused is read by the sound
        // thread and written from the main thread via pauseAll()/resumeAll().
        // Using std::atomic<bool> avoids a data race without needing a mutex.
