...
OpenALSoundManager::~OpenALSoundManager()
{
        ...
        m_sounds_streaming_current_bigstep.clear();
        m_sounds_streaming_next_bigstep.clear();
        m_sounds_fading.clear();

        // Clear sound data to ensure OpenAL buffers are freed via alDeleteBuffers()
