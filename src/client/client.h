...
public:
        ...
        */
        ...
        void setConnectionSecurity(ConnectionSecurity sec) { m_security_info.state = sec; }
        bool isConnectionSecure() const { return m_security_info.isSecure(); }

        // Detailed connection security information
...
private:
        ...
        // Connection security info (default: Insecure until server confirms otherwise)
