        ...
        m_client(client)
{
        ...
        // Register settings callback so cached values are refreshed at runtime.
        g_settings->registerChangedCallback("smooth_lighting",
                &MeshUpdateQueue::settingsChangedCallback, this);
        g_settings->registerChangedCallback("enable_water_reflections",
                &MeshUpdateQueue::settingsChangedCallback, this);
}
