...
private:
        ...
        // NOTE: m_generation_interval is cached from g_settings at startup and never
        // updated. It should be refreshed via a SettingsCallback registered in the
        // constructor, similar to MeshUpdateQueue's cached settings.
