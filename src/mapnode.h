...
struct alignas(u32) MapNode
{
        ...
        */
        ...
        /*!
         * Sets the node's raw light level in param1 directly, without
         * the has_light check or light_source consideration of setLight().
         * This is a lightweight alternative for hot loops (e.g. lighting
         * propagation in mapgen) where ContentLightingFlags are already
         * known to be valid.
         * \param bank Which light bank to set (day or night)
         * \param a_light Light value (0–15)
         */
        inline void setLightRaw(LightBank bank, u8 a_light) noexcept
        {
                if (bank == LIGHTBANK_DAY) {
                        param1 &= 0xf0;
                        param1 |= a_light & 0x0f;
