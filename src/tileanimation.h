...
struct TileAnimationParams
{
	...
	// Calculate animation length based on particle expiration time
	// If length or frame_length is negative, it means "match particle lifetime"
	void calculateForParticle(float expirationtime);
};
