...
const luaL_Reg LuaLocalPlayer::methods[] = {
                ...
                //
                // Audit status (v9.56):
                //   - get_last_pos: Useful for movement prediction interpolation.
                //     Used by some CSM mods for smooth camera. Keep for now.
                //   - get_last_velocity: Useful for impact/prediction effects.
                //     Low usage but no simpler alternative. Keep for now.
                //   - get_last_look_horizontal/vertical: Useful for aim prediction.
                //     Could be deprecated if no mods use them; the current look
                //     direction is available via get_pitch/get_yaw. Candidate for
                //     deprecation after a survey of CSM mod usage.
