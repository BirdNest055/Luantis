...
void ActiveObjectMgr::updateObjectPos(u16 id, v3f pos)
{
        ...
        // insert a stale entry into m_spatial_index for an object that might not
        // exist in the main container, causing orphaned spatial index entries.
        //
        // Root cause: The object lifecycle (create → setPos → add to m_active_objects)
