                ...
                gui::IGUIFont *font) const
{
        ...
        static const video::SColor usable_colors[] = {
                GUITheme::Colors::PROFILER_COLOR_1,
                GUITheme::Colors::PROFILER_COLOR_2,
                GUITheme::Colors::PROFILER_COLOR_3,
                GUITheme::Colors::PROFILER_COLOR_4,
                GUITheme::Colors::PROFILER_COLOR_5,
                GUITheme::Colors::PROFILER_COLOR_6,
                GUITheme::Colors::PROFILER_COLOR_7,
                GUITheme::Colors::PROFILER_COLOR_8,
        };
        u32 next_color_i = 0;

        for (auto &i : m_meta) {
                Meta &meta = i.second;
                video::SColor color = GUITheme::Colors::PROFILER_FALLBACK;
        ...
        const s32 graphh = GUITheme::Sizing::PROFILER_GRAPH_HEIGHT;
        s32 textx = x_left + m_log_max_size + GUITheme::Sizing::PROFILER_TEXT_X_OFFSET;
        s32 textx2 = textx + GUITheme::Sizing::PROFILER_TEXT_WIDTH - GUITheme::Sizing::PROFILER_TEXT_X_OFFSET;
        s32 meta_i = 0;
