...
void ParsedText::Element::setStyle(StyleList &style)
{
        ...
        font_size = myround(font_size / GUITheme::Fonts::FONT_SCALE_DIVISOR * g_fontengine->getFontSize(font_mode));
...
ParsedText::ParsedText(const wchar_t *text)
{
        ...
        m_root_tag.style["fontsize"] = GUITheme::Fonts::FONT_SIZE_DEFAULT;
        m_root_tag.style["fontstyle"] = GUITheme::Fonts::FONT_MODE_NORMAL;
        m_root_tag.style["bold"] = "false";
        m_root_tag.style["italic"] = "false";
        m_root_tag.style["underline"] = "false";
        m_root_tag.style["halign"] = "left";
        m_root_tag.style["color"] = "#EEEEEE"; // GUITheme::Colors::HYPERTEXT_DEFAULT
        m_root_tag.style["hovercolor"] = "#FF0000"; // GUITheme::Colors::HYPERTEXT_HOVER
        ...
        style["color"] = "#0000FF"; // GUITheme::Colors::HYPERTEXT_LINK
        ...
        style["fontsize"] = GUITheme::Fonts::FONT_SIZE_BIG;
        m_elementtags["big"] = style;
        style.clear();

        style["fontsize"] = GUITheme::Fonts::FONT_SIZE_BIGGER;
        ...
        for (auto &p : m_text.m_paragraphs) {
                for (auto &e : p.elements) {
                        ...
                        case ParsedText::ELEMENT_ITEM:
                                ...
                                core::dimension2d<u32> dim = GUITheme::Sizing::HYPERTEXT_IMAGE_SIZE;
                ...
                m_drawer(text, client, environment, tsrc), m_text_scrollpos(0, 0)
{
        ...
        m_scrollbar_width = skin ? skin->getSize(gui::EGDS_SCROLLBAR_SIZE) : GUITheme::Sizing::HYPERTEXT_SCROLLBAR_WIDTH;
