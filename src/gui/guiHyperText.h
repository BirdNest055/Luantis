...
public:
        ...
        struct Element
        {
                ...
                s32 margin = GUITheme::Sizing::HYPERTEXT_MARGIN_DEFAULT;
        ...
        struct Paragraph
        {
                ...
                HalignType halign;
                s32 margin = GUITheme::Sizing::HYPERTEXT_MARGIN_PARAGRAPH;
        ...
        // Element style
        s32 margin = GUITheme::Sizing::HYPERTEXT_MARGIN_GLOBAL;
