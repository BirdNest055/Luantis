...
protected:
        ...
        bool m_border = true;
        video::SColor m_color = GUITheme::Colors::TABLE_TEXT_DEFAULT;
        video::SColor m_background = GUITheme::Colors::TABLE_BG_DEFAULT;
        video::SColor m_highlight = GUITheme::Colors::TABLE_HIGHLIGHT;
        video::SColor m_highlight_text = GUITheme::Colors::TABLE_HIGHLIGHT_TEXT;
        s32 m_rowheight = 1;
