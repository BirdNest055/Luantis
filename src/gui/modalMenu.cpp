...
bool PointerAction::isRelated(PointerAction previous) {
        ...
        return time_delta < GUITheme::Timing::DOUBLECLICK_THRESHOLD_MS && distance_sq < (GUITheme::Sizing::DOUBLECLICK_DISTANCE * GUITheme::Sizing::DOUBLECLICK_DISTANCE);
}
...
GUIModalMenu::GUIModalMenu(gui::IGUIEnvironment* env, gui::IGUIElement* parent,
        s32 id, IMenuManager *menumgr, bool remap_click_outside) :
                IGUIElement(gui::EGUIET_ELEMENT, env, parent, id,
                                core::rect<s32>(0, 0, GUITheme::Sizing::MODAL_DEFAULT_SIZE.Width, GUITheme::Sizing::MODAL_DEFAULT_SIZE.Height)),
#ifdef __ANDROID__
                m_jni_field_name(""),
#endif
                m_menumgr(menumgr),
...
{
        m_gui_scale = g_settings->getFloat("gui_scaling", GUITheme::Sizing::GUI_SCALE_MIN, GUITheme::Sizing::GUI_SCALE_MAX) *
