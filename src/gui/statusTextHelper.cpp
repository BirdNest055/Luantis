...
StatusTextHelper::StatusTextHelper(gui::IGUIEnvironment *guienv, gui::IGUIElement *parent)
{
        ...
        if (guienv->getSkin())
                ...
                m_text_color = GUITheme::Colors::STATUS_TEXT_FALLBACK;
}
...
{
        m_display_duration = GUITheme::Timing::STATUS_TEXT_DURATION_GAME;
...
{
        m_display_duration = GUITheme::Timing::STATUS_TEXT_DURATION_MENU;
        m_background_color = GUITheme::Colors::STATUS_TEXT_MAIN_BG;
...
void StatusTextHelper::updatePosition()
{
        ...
        if (m_use_main_menu_position) {
                ...
                const s32 status_y = (s32)screensize.Y - GUITheme::Sizing::STATUS_TEXT_Y_OFFSET;
