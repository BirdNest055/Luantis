...
void GUITouchscreenLayout::drawMenu()
{
        ...
        video::SColor bgcolor = GUITheme::Colors::MODAL_BG;
        video::SColor selection_color = GUITheme::Colors::TOUCH_SELECTION;
        video::SColor error_color = GUITheme::Colors::TOUCH_ERROR;
