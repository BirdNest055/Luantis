...
public:
        ...
        struct Options {
                ...
                video::SColor slotbordercolor = GUITheme::Colors::SLOT_BORDER;
                // colors for normal and highlighted slot background
                video::SColor slotbg_n = GUITheme::Colors::SLOT_BG_NORMAL;
                video::SColor slotbg_h = GUITheme::Colors::SLOT_BG_HOVERED;
        };
