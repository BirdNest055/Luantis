...
void GUIFormSpecMenu::parseList(parserData *data, const std::string &element)
{
        ...
        v2f32 default_spacing = data->real_coordinates ?
                        v2f32(imgsize.X * GUITheme::Sizing::SLOT_SPACING_RATIO, imgsize.Y * GUITheme::Sizing::SLOT_SPACING_RATIO) :
...
void GUIFormSpecMenu::parsePwdField(parserData* data, const std::string &element)
{
        ...
        e->setOverrideColor(style.getColor(StyleSpec::TEXTCOLOR, GUITheme::Colors::TEXT_DEFAULT));
        e->setOverrideFont(style.getFont());
...
void GUIFormSpecMenu::parseTabHeader(parserData* data, const std::string &element)
{
        ...
        for (const std::string &button : buttons) {
                ...
                tab->setTextColor(style.getColor(StyleSpec::TEXTCOLOR, GUITheme::Colors::TEXT_DEFAULT));
        }
...
void GUIFormSpecMenu::regenerateGui(v2u32 screensize)
{
        ...
        mydata.padding = v2f32(GUITheme::Sizing::PADDING_RATIO, GUITheme::Sizing::PADDING_RATIO);
        ...
        m_bgcolor = GUITheme::Colors::MODAL_BG;
        ...
        m_default_tooltip_bgcolor = GUITheme::Colors::TOOLTIP_BG;
        m_default_tooltip_color = GUITheme::Colors::TOOLTIP_TEXT;
        ...
        // Add tooltip
        {
                ...
                m_tooltip_element = gui::StaticText::add(Environment, L"",
                        core::rect<s32>(0, 0, GUITheme::Colors::TOOLTIP_INITIAL_SIZE.Width, GUITheme::Colors::TOOLTIP_INITIAL_SIZE.Height));
        ...
        if (mydata.explicit_size) {
                ...
                m_btn_height = use_imgsize * GUITheme::Sizing::BUTTON_HEIGHT_RATIO;
...
double GUIFormSpecMenu::getFixedImgsize(double screen_dpi, double gui_scaling)
{
        ...
        return GUITheme::Sizing::FIXED_IMGSIZE_DPI_MULT * screen_dpi * gui_scaling;
}
