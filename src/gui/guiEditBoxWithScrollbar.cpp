...
void GUIEditBoxWithScrollBar::draw()
{
        ...
        if (m_bg_color_used) {
                ...
                // Transparent
                OverrideBgColor = GUITheme::Colors::EDIT_BG_OVERRIDE;
        }
...
void GUIEditBoxWithScrollBar::createVScrollBar()
{
        ...
        VScrollBar->setSmallStep(GUITheme::Sizing::EDIT_SCROLL_SMALL_STEP * fontHeight);
        VScrollBar->setLargeStep(GUITheme::Sizing::EDIT_SCROLL_LARGE_STEP * fontHeight);
}
