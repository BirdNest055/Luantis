...
void ServerMap::finishBlockMake(BlockMakeData *data,
        std::unordered_map<v3s16, MapBlock*> *changed_blocks, ServerEnvironment *env)
{
        assert(data);
...
bool ServerMap::saveBlock(MapBlock *block, MapDatabase *db, int compression_level)
{
        ...
        */
        ...
        // TODO: Use C++20 zero-copy or custom rdbuf
...
void ServerMap::transformLiquidsLocal(std::unordered_map<v3s16, MapBlock*> &modified_blocks, UniqueQueue<v3s16> &liquid_queue,
...
void ServerMap::transformLiquids(std::unordered_map<v3s16, MapBlock*> &modified_blocks,
