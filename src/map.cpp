...
void MMVManip::initialEmerge(v3s16 p_min, v3s16 p_max, bool load_if_inexistent)
{
        ...
        std::unordered_set<v3s16> had_blocks;
...
std::unordered_set<v3s16> MMVManip::getCoveredBlocks() const
{
        std::unordered_set<v3s16> ret;
...
void MMVManip::blitBackAll(std::unordered_map<v3s16, MapBlock*> *modified_blocks,
