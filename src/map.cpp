...
bool Map::isBlockOccluded(v3s16 pos_relative, v3s16 cam_pos_nodes, bool simple_check)
{
        ...
        // this is a workaround, we should think of a more precise occlusion algorithm
        // that doesn't require random sampling. A voxel traversal approach (like
        // Bresenham 3D) would be more deterministic and accurate.
        u32 needed_count = 2;
