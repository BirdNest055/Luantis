...
// NOTE: These SDL button constants are defined here as a compatibility shim because
// SDL headers are not available in the IrrlichtMt include path. Once SDL headers
// are accessible to all Luanti compilation units (e.g., via a dedicated SDL include
// directory or sdl2-config --cflags propagated to all targets), this block and the
// #ifndef guard should be removed in favor of the canonical SDL definitions.
