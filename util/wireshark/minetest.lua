...
function minetest_check_length(tvb, min_len, t)
        ...
        -- NOTE: The reported_length_remaining() branch handles reassembled packets where only
        -- part of the Luanti protocol message was captured. Other dissectors in this file
        -- currently check tvb:len() directly, which fails for reassembled TCP segments.
        -- To fix: replace tvb:len() checks with minetest_check_length() or
        -- tvb:reported_length_remaining() throughout all command dissectors.
