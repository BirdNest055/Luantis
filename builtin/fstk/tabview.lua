...
--                                                                            --
-- NOTE: Each tab must provide a cbf_formspec function. Optional callbacks:   --
-- cbf_button_handler (formspec button events), cbf_events (custom events).  --
-- Tab size can be overridden per-tab via the `tabsize` field; if omitted,    --
-- the tabview's own size is used. The `caption` field is the tab label shown --
-- in the header bar; `name` is the internal identifier.                     --
--------------------------------------------------------------------------------
