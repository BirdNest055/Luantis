...
function ui.add(child)
        -- Validate that the child has the required interface
        assert(type(child) == "table", "ui.add: child must be a table, got " .. type(child))
        assert(type(child.name) == "string" and child.name ~= "",
                "ui.add: child must have a non-empty 'name' string property")
