...
function vector.new(a, b, c)
        ...
        -- NOTE: vector.new(a) and vector.new() are deprecated forms kept for backward
        -- compatibility. Use vector.copy(v) instead of vector.new(v), and vector.zero()
        -- instead of vector.new(). The three-argument form vector.new(x,y,z) is preferred.
