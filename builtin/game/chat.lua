...
-- NOTE: core.chatcommands is an alias for core.registered_chatcommands, preserved
-- for backward compatibility. Mods should use core.registered_chatcommands instead.
-- This alias can be removed in a future major version once all mods have migrated.
