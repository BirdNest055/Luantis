        ...
        on_step = function(self, dtime, moveresult)
                ...
                if not bcp then
                        ...
                        if player_collision then
                                ...
                                -- their collision box
                                -- NOTE: This hack restores the falling object's velocity to its
                                -- pre-collision value and nudges it downward, so it passes through
                                -- standing players instead of stopping on top of them. Without this,
                                -- falling nodes would land on players and float.
                                -- Root cause: The collision system treats all objects uniformly —
                                -- there is no way for a falling object to declare "ignore player
                                -- collisions." The fix would be a per-object collision mask or
                                -- collision group system (e.g., entity.collision_ignore = {"player"}),
                                -- allowing selective filtering during the broad/narrow phase.
