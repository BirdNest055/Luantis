...
-- NOTE: register_privilege can be called with either a string (description only)
-- or a table with fields: description, give_to_singleplayer, give_to_admin.
-- By default, give_to_singleplayer=true and give_to_admin follows its value.
-- This means newly registered privileges are granted to singleplayer automatically
-- unless explicitly set to false — mod authors should be aware of this default.
