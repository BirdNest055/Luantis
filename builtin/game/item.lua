...
core.nodedef_default = {
        ...
        -- NOTE: legacy_facedir_simple and legacy_wallmounted are compatibility flags
        -- for nodes that predate the paramtype2 system. When set to true, the engine
        -- auto-sets paramtype2 to "facedir" or "wallmounted" respectively. These should
        -- not be used by new mods — set paramtype2 directly instead. Removal blocked on
        -- confirming no remaining content depends on them.
