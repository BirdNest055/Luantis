...
-- were historically mislabeled — they produce value noise, not Perlin noise.
-- No deprecation warning is logged yet to avoid breaking existing mods silently.
-- Migration plan (mirrors emerge/env.lua):
...
--   3. A correct Perlin noise implementation could be added as core.get_perlin_noise.
